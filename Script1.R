...
styled_table <- kable(data, format = "html", align = "c") %>%
...
kable_output <- kable(funding_metadata, "html", escape = FALSE) %>%
  kable_styling(full_width = F, position = "left", font_size = 12) %>%
  column_spec(1, bold = T, border_right = T) %>%
  row_spec(0, bold = T, background = "#D3D3D3") %>%
  add_header_above(c(" " = 1, "Organizers" = 2, "Scholars" = 2, "Total" = 2))
...
styled_table <- kable(pids_data, "html") %>%
  kable_styling(full_width = F, position = "left", font_size = 12) %>%
  column_spec(1, bold = T, border_right = T) %>%
  row_spec(0, bold = T, background = "#D3D3D3") %>%
  add_header_above(c(" " = 1, "Organizers" = 2, "Scholars" = 2, "Total" = 2))
...
styled_table <- kable(methods_data, "html", escape = FALSE) %>%
  kable_styling(full_width = F, position = "left", font_size = 12) %>%
  column_spec(1, bold = T, border_right = T) %>%
  row_spec(0, bold = T, background = "#D3D3D3") %>%
  add_header_above(c(" " = 1, "Organizers" = 2, "Scholars" = 2, "Total" = 2))
...
styled_table <- kable(importance_data, "html", escape = FALSE) %>%
  kable_styling(full_width = F, position = "left", font_size = 12) %>%
  column_spec(1, bold = T, border_right = T) %>%
  row_spec(0, bold = T, background = "#D3D3D3") %>%
  add_header_above(c(" " = 1, "Organizers" = 2, "Scholars" = 2, "Total" = 2))
...
styled_table <- kable(metadata_accuracy, "html", escape = FALSE) %>%
  kable_styling(full_width = F, position = "left", font_size = 12) %>%
  column_spec(1, bold = T, border_right = T) %>%
  row_spec(0, bold = T, background = "#D3D3D3") %>%
  add_header_above(c(" " = 1, "Organizers" = 2, "Scholars" = 2, "Total" = 2))
...
styled_table <- kable(difficulty_data, "html", escape = FALSE) %>%
  kable_styling(full_width = F, position = "left", font_size = 12) %>%
  column_spec(1, bold = T, border_right = T) %>%
  row_spec(0, bold = T, background = "#D3D3D3") %>%
  add_header_above(c(" " = 1, "Organizers" = 2, "Scholars" = 2, "Total" = 2))
...
styled_table <- kable(state_metadata_ukraine, "html", escape = FALSE) %>%
  kable_styling(full_width = F, position = "left", font_size = 12) %>%
  column_spec(1, bold = T, border_right = T) %>%
  row_spec(0, bold = T, background = "#D3D3D3") %>%
  add_header_above(c(" " = 1, "Organizers" = 2, "Scholars" = 2, "Total" = 2))
...
kable_styled <- documents_data %>%
  kable("html", booktabs = TRUE, align = 'lccc', col.names = c("Document", "Organizers N", "Organizers %", "Scholars N", "Scholars %", "Total N", "Total %")) %>%
...
kable_styled <- metadata_quality_factors %>%
  kable("html", booktabs = TRUE, align = 'lccc', col.names = c("Factor", "Organizers N", "Organizers %", "Scholars N", "Scholars %", "Total N", "Total %")) %>%
  kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover"), position = "left")
...
kable_output <- kable(satisfaction_data, "html", booktabs = TRUE, 
                      col.names = c("Satisfaction Level", "Organizers N", "Organizers %", "Scholars N", "Scholars %", "Total N", "Total %")) %>%
...
kable_styled <- kable(mistakes_data, "html", booktabs = TRUE,
                      col.names = c("Frequency of Mistakes", "Organizers N", "Organizers %", "Scholars N", "Scholars %", "Total N", "Total %")) %>%
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = F, position = "left")
...
kable_styled <- kable(importance_metadata_quality, "html", booktabs = TRUE, 
                      col.names = c("Importance Level", "Organizers N", "Organizers %", "Scholars N", "Scholars %", "Total N", "Total %")) %>%
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = F, position = "left")
